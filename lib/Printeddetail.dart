  ...
  Future<List<hischecked>?> _sendrequest() async {
    ...
    try {
      var response = await http.get(
        Uri.parse(
            "https://evdc-api.onrender.com/api/v1/print_queues/${widget.general.id}?voucher_skip=0&voucher_limit=${widget.general.quantity}"), //http://137.184.214.159:8000/
        headers: {
      ...
      if (response.statusCode == 200) {
        ...
        print("good to go");
        print("total count is ${detailhistory.quantity}");
